    ...
    <el-card>
      ...
      >
        ...
        <p class="section-desc">
          流水线由多个阶段组成，每个阶段包含一个或多个作业
        </p>

        <div
          v-for="(stage, stageIndex) in formState.stages"
          :key="stageIndex"
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="job.image"
                    placeholder="请输入Docker镜像，例如：node:16"
                  />
                </el-form-item>
              </el-col>
            </el-row>
...
const rules = {
  ...
  git_repo: [{ required: true, message: "请输入Git仓库地址", trigger: "blur" }],
