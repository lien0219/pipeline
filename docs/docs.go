        ...
        "/build-template/build-history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "排序字段(id/start_time/duration)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.PipelineChartData"
                                        }
                                    }
                                }
                            ]
